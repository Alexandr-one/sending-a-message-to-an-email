            ...
            <div class="modal-body">
                <form action="send" class='ml-3'>
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                                ...
                                <input name='sendEmail' placeholder="Почта" style="margin-left: 20px;"/>
                                <input name='sendTitle' type='text' placeholder="Тема сообщения" style="margin-left:110px;margin-top:20px;"/>
                            <br>
                                <textarea name='sendText' type='text' placeholder="Текст" style="margin-left: 110px; margin-top:20px;"></textarea>
                    <td colspan='2'></td>
